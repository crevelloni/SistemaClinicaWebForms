    ...
    <div class="form-box" id="login-box">
        ...
        <form id="form1" runat="server">
            <div class="body bg-gray">
                ...
                <div class="form-group">
                    <asp:TextBox ID="txtPassword" runat="server" CssClass="form-control" placeholder="Senha"></asp:TextBox>
                </div>
            </div>
            <div class="footer">
                <asp:Button ID="btnEntrar" runat="server" Text="Iniciar sessão" CssClass="btn bg-olive btn-block"/>
            </div>
        </form>
    </div>
